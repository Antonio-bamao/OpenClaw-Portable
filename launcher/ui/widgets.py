...
class HeroPanel(QFrame):
    def __init__(self, title: str, subtitle: str, parent: QWidget | None = None) -> None:
        ...
        text_layout.addWidget(make_label(title, "HeroTitle", size=24, weight=QFont.Bold))
        ...
        status_layout.addWidget(make_label("运行中 / 可联调", "HeroTitle", size=18, weight=QFont.Bold))
