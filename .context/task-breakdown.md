...
1. 维护项目上下文系统与摘要一致性
   ...
   - 明确区分“已公开发布的 `v2026.04.5`”与“仅在本地源码 / dist 中存在、尚未公开发布的 2026-04-17 至 2026-04-19 微信 / QQ、UI 与启动路径改进”
...
3. 决定并准备下一版公开发布
   - 若要让用户拿到 2026-04-17 至 2026-04-19 的微信 / QQ 帮助、状态 UX、真实 onboarding、中文 UI 布局修复、mock 飞书状态修正与简化启动改进，则基于当前源码和 `dist/OpenClaw-Portable` 准备 post-`v2026.04.5` release
