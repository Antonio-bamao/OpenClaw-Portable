...
- Package rebuild verification passed in the primary workspace because the isolated worktree does not contain ignored local build artifacts (`runtime/openclaw` and `dist/OpenClaw-Portable`).
